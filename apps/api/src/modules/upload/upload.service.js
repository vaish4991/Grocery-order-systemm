...
var UploadService = function () {
    ...
    var UploadService = _classThis = /** @class */ (function () {
        function UploadService_1(config) {
            this.config = config;
        ...
        UploadService_1.prototype.getPresignedUploadUrl = function (folder, filename, contentType) {
            return __awaiter(this, void 0, void 0, function () {
                var extension, key, command, url;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            extension = filename.split('.').pop();
                            key = "".concat(folder, "/").concat((0, uuid_1.v4)(), ".").concat(extension);
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    uploadUrl: url,
                                    fileKey: key,
                                    fileUrl: "https://".concat(this.bucket, ".s3.").concat(this.config.get('AWS_REGION', 'ap-south-1'), ".amazonaws.com/").concat(key),
                                }];
                    }
                });
            });
        };
        UploadService_1.prototype.deleteFile = function (key) {
            return __awaiter(this, void 0, void 0, function () {
                var command;
                return __generator(this, function (_a) {
                    switch (_a.label) {
