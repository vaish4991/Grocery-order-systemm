...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.isEmailVerified = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _isEmailVerified_initializers, void 0));
            ...
            this.createdAt = (__runInitializers(this, _isPhoneVerified_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _phone_decorators = [(0, typeorm_1.Column)({ unique: true, length: 15 })];
        _password_decorators = [(0, typeorm_1.Column)({ select: false })];
        _role_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: UserRole, default: UserRole.CUSTOMER })];
