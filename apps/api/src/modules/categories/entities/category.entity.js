...
var Category = function () {
    ...
    var Category = _classThis = /** @class */ (function () {
        function Category_1() {
            ...
            this.isActive = (__runInitializers(this, _image_extraInitializers), __runInitializers(this, _isActive_initializers, void 0));
        ...
        Category_1.prototype.generateSlug = function () {
    ...
    (function () {
        ...
        _slug_decorators = [(0, typeorm_1.Column)({ unique: true, length: 150 })];
        ...
        _generateSlug_decorators = [(0, typeorm_1.BeforeInsert)(), (0, typeorm_1.BeforeUpdate)()];
        __esDecorate(_classThis, null, _generateSlug_decorators, { kind: "method", name: "generateSlug", static: false, private: false, access: { has: function (obj) { return "generateSlug" in obj; }, get: function (obj) { return obj.generateSlug; } }, metadata: _metadata }, null, _instanceExtraInitializers);
