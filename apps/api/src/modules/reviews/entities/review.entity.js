...
var Review = function () {
    ...
    var Review = _classThis = /** @class */ (function () {
        function Review_1() {
            ...
            this.productId = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _productId_initializers, void 0));
            this.product = (__runInitializers(this, _productId_extraInitializers), __runInitializers(this, _product_initializers, void 0));
            this.rating = (__runInitializers(this, _product_extraInitializers), __runInitializers(this, _rating_initializers, void 0));
            ...
            this.createdAt = (__runInitializers(this, _isVerifiedPurchase_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, { onDelete: 'CASCADE', eager: true }), (0, typeorm_1.JoinColumn)({ name: 'userId' })];
        _productId_decorators = [(0, typeorm_1.Column)()];
        _product_decorators = [(0, typeorm_1.ManyToOne)(function () { return product_entity_1.Product; }, { onDelete: 'CASCADE' }), (0, typeorm_1.JoinColumn)({ name: 'productId' })];
        _rating_decorators = [(0, typeorm_1.Column)({ type: 'int' })];
        _comment_decorators = [(0, typeorm_1.Column)({ type: 'text', nullable: true })];
        _isVerifiedPurchase_decorators = [(0, typeorm_1.Column)({ default: false })];
