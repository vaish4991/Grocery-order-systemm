...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, allowedOrigins, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    console.log("\uD83D\uDE80 GOS API running on: http://localhost:".concat(port));
                    console.log("\uD83D\uDCD6 Swagger docs: http://localhost:".concat(port, "/api/docs"));
                    return [2 /*return*/];
            }
        });
    });
